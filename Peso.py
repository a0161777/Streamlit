...
st.write(''' # Predicción del peso  ''') # el titulo que se agrega a la app
st.image("Bascula.jpg", caption="Predicción del peso de una persona.") # pie de figura
# nombre en el cual se guardo la imagen
st.header('Datos personales') # encabezado
...
#predicción de peso
  user_input_data = {'AGE': Edad,
                     ...
                     'HEIGHT': Altura,
                     'WAIST': Cintura,
                     'ARM CIRC': Brazo,# columna de la ciencia de datos es la roja, se debe de llamar igual al sistema de datos
                     'BMI': IMC,
                     }
